...
class gru_ljp():
    ...
    def load_model(self, DATA="SMALL"):
        ...
        if DATA == "SMALL":
            self.corpus_info_path = "../dataprocess/lang-CAIL-SMALL-WORD.pkl"
            ...
            if (step + 1) % self.EPOCH == 0:
                ...
                for val_seq, val_charge_label, val_article_label, val_penalty_label in data_loader(valid_seq,
                    ...
                    with torch.no_grad():
                        ...
                        val_article_preds_loss = criterion(val_article_preds,
                                                           torch.tensor(val_article_label).to(device))
                        val_penalty_preds_loss = criterion(val_penalty_preds,
